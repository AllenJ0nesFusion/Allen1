...
export default function BriefingPage() {
  ...
  return (
    <div className="max-w-3xl">
      <h1 className="page-title text-2xl mb-1">Briefing Generator</h1>
      <p className="text-sm text-[#404D5B] mb-5">
        Drafts a paste-ready L&D Goals Tracker status update from your current task data.
      </p>

      <button
        onClick={generate}
        disabled={loading}
        className="px-5 py-2.5 text-sm font-semibold text-white rounded-md transition-all hover:shadow-md disabled:opacity-80"
